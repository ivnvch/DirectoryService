import {
  PAGE_SIZE,
  useLocationsQuery,
} from "@/features/locations/model/use-locations-query";
...
import { LocationFilters } from "../model/locations-filters";
import { useGetLocationsFilter } from "../model/location-filter-store";
...
export default function LocationsList() {
  ...
  const { search, isDeleted, pageSize } = useGetLocationsFilter();
